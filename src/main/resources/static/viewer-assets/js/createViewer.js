$(function() {
    ...
    var documentID = scriptSrc.attr('documentID');
    var imageHandlerUrl = scriptSrc.attr('imageHandlerUrl');
    var viewerAssetsPath = scriptSrc.attr('viewerAssetsPath');
    var resourcePath = scriptSrc.attr('resourcePath');

    $('#viewerContainer').pccViewer({
        documentID:       documentID,
        imageHandlerUrl:  imageHandlerUrl,      // Base path the viewer should use to make requests to PAS (PrizmDoc Application Services).
        viewerAssetsPath: viewerAssetsPath,     // Base path the viewer should use for static assets
        resourcePath:     resourcePath,         // Base path the viewer should use for images
